...
module.exports = {
    ...
    Clone: donor=>JSON.parse(JSON.stringify(donor)),
    LogAndThrow: error => { console.error(error); throw error; },
    LogAndThrowAsync: error => { setTimeout(()=>{console.error(error);}); throw error; },
    Uuid: uuid.v4,
};
